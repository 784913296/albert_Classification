...
class Args():
    ...
    def initialize(parser: argparse.ArgumentParser):
        parser.add_argument('--data_dir', default='./data/cnews', help='数据集目录')
        ...
        parser.add_argument('--baseline_dir', default='./baseline/albert', help='baseline 模型目录')
        ...
        parser.add_argument('--save_steps', type=int, default=100, help="多少个step保存一次模型")
